...
public final class HotelTestData {
    ...
    public static final UUID STANDARD_ROOM_ID = UUID.fromString("e1111111-1111-1111-1111-111111111111");
    ...
    public static RoomTypeInput aRoomType(String name, int totalRooms) {
        return new RoomTypeInput(name, totalRooms, 2, aMoneyRequest());
    }
    ...
    public static UpdateHotelRequest anUpdateHotelRequest(List<RoomTypeInput> roomTypes) {
        return new UpdateHotelRequest(NAME, CITY, COUNTRY, RATING, roomTypes, List.of("WiFi"), List.of());
    }
    ...
    public static Hotel aHotel() {
        Hotel hotel = new Hotel(HOTEL_ID, NAME, CITY, COUNTRY, RATING, HotelStatus.ACTIVE);
        hotel.addRoomType(new RoomType(
                STANDARD_ROOM_ID, STANDARD, STANDARD_TOTAL_ROOMS, 2,
    ...
    public static HotelResponse aHotelResponse() {
        return new HotelResponse(
                HOTEL_ID, NAME, CITY, COUNTRY, RATING, HotelStatus.ACTIVE,
